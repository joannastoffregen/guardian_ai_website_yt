...
1. How does Guardian AI integrate with my existing stack?  
2. Is Guardian AI SOC2 compliant?  
3. How is the threat score calculated?  
4. Does Guardian AI work for small teams?  
5. Can I deploy Guardian AI on-prem?  
6. What does the AI Analyst actually do?  

**Footer Line:**  
Still have questions? We're here to help.  
**Links:**  
Read our documentation → | Chat with support →

## Component and Design Instruction 
Format this section in collapsible accordions (shadcn/ui Accordion).
